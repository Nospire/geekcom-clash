...
func GenerateConfig(o Opts) error {
	...
	// Маячок: видимое доказательство, что конфиг сгенерил Go-движок (не Python).
	header := []byte("# generated by geekcom-clash Go engine (nightly)\n")
	return os.WriteFile(o.NewPath, append(header, out...), 0o644)
}
